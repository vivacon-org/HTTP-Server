...
/**
 * The {@code BeanFactory} class is responsible for creating and managing bean instances.
 * It provides the mechanism to instantiate beans, inject dependencies, and manage singleton instances.
 * This class follows the singleton pattern to ensure only one instance of the factory is used throughout the application.
 */
public class BeanFactory {
    ...
    public Object[] populateDependencies(LinkedHashMap<Field, Set<String>> dependencyToItsBindNames,
                                         Map<String, Set<Object>> bindNameToBeans) {
        if (dependencyToItsBindNames == null || dependencyToItsBindNames.isEmpty()) {
            return new Object[0];
        }
